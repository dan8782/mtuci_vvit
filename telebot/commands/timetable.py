...
def timetable(message):
    ...
    nech = simple_select(conn, cur, select_what=['class_name'], select_from='qtimetable', where="week = 'неч'")
    ch = simple_select(conn, cur, select_what=['class_name'], select_from='qtimetable', where="week = 'чет'")
